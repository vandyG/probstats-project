...
def get_version(dist: str = "probstats-project") -> str:
...
def get_debug_info() -> Environment:
    ...
    packages = ["probstats-project"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("PROBSTATS_PROJECT")]]
    return Environment(
